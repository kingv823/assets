...
-- Boutons de contrôle (Rouge, Jaune, Vert)
...
-- LE BOUTON START AUTO FARM (Forcé au premier plan)
...
FarmButton.MouseButton1Click:Connect(function()
    ...
    if farming then
        ...
        FarmButton.BackgroundColor3 = Color3.fromRGB(255, 59, 48) -- Rouge bouton actif
